...
export function Btn({ children, variant = "primary", size = "md", onClick, disabled }: BtnProps) {
  ...
  const v = {
    primary: { bg: h ? "#f0f0f0" : "rgba(255,255,255,0.92)", color: "#0a0a0f", border: "1px solid rgba(255,255,255,0.15)" },
    glass: { bg: h ? U.glassHi : U.glass, color: U.text, border: `1px solid ${h ? U.borderHi : U.border}`, backdropFilter: "blur(12px)" },
    cyan: { bg: h ? "rgba(34,211,238,0.22)" : U.cyanSoft, color: U.cyan, border: "1px solid rgba(34,211,238,0.28)" },
  }[variant] || {};
